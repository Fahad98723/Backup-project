...
const LocationRecommended = ({ name, content }) => {
  ...
  const filterByLocation = async (locName) => {
    try {
      const { data } = await axios.get(
        `${host}/institute?approval=1&location=${locName === "Jangpura" ? "Jungpura" : locName
        }&nolimit=true`
      );
      console.log(data.message);
      console.log(data.message, "538", locName);
  ...
  const filterBySearch = async (text, area) => {
    ...
    try {
      const { data } = await axios.get(
        `${host}/institute/query?approval=1&name=${text}&location=${area}&limit=50`
      );
  ...
  const filterByCategory = async (cat) => {
    try {
      ...
      const { data } = await axios.get(
        `${host}/institute?approval=1&services=${query}&location=${locationBy || locationQuery
        }&limit=50`
      );
    ...
    try {
      axios
        ...
        .then(function (response) {
          ...
          console.log(response.data.message, "toplocation via state");
        });
    } catch (err) {
      console.log(err);
    }
  ...
  console.log(topLocationData, institutes, state, allInstitutes, "checking");
  ...
  console.log(locationQuery, locationBy, "locatioby");
  ...
  return (
    <div className="p-5 sm:p-10 ">
      ...
      <div className=" md:flex grid grid-cols-2 gap-2  items-center my-5">
        <div className="relative  my-1">
          <p
            ...
            className="flex w-full justify-between md:w-44 items-center  cursor-pointer border-4 border-solid border-primary    p-2"
          >
                ...
                <div className="py-1 divide-y divide-gray/20" role="none">
                  {sortData?.map((element, idx) => {
                    return (
                      <div
                        key={idx}
                        className={`flex ${sortBy === element.name
                          ? "text-primary"
                          : "text-[#000000]"
                ...
                >
                  {states?.map((element, idx) => {
                    return (
                      <div
                        key={idx}
                        className={`flex ${state === element.value
                          ? "text-primary"
                          : "text-[#000000]"
                          }   justify-between cursor-pointer  items-center`}
                        onClick={() => {
                ...
                >
                  {locations?.map((element, idx) => {
                    return (
                      <div
                        key={idx}
                        className={`flex ${locationBy === element.value
                          ? "text-primary"
                          : "text-[#000000]"
                          }   justify-between cursor-pointer  items-center`}
                        onClick={(e) => {
                          ...
                          filterByLocation(element.value || locationQuery);
                        }}
                      >
                        <p className={`  text-[16px]  px-4 py-2 `}>
                          {element.name}
        ...
        <div className="relative  my-1">
          <p
            ...
            className="flex w-full justify-between md:w-44 items-center  cursor-pointer border-2 border-solid border-light-gray   p-2 "
          >
            <p className={` text-[#000000] text-[14px] `}>
              {type
                ? type === 1
                ...
                <div className="py-1 divide-y divide-gray/20" role="none">
                  {modeData?.map((element, idx) => {
                    return (
                      <div
                        key={idx}
                        className={`flex ${type === element.value
                          ? "text-primary"
                          : "text-[#000000]"
                          }   justify-between cursor-pointer  items-center`}
                        onClick={() => {
                    ...
                    >
                      {classData?.map((element, idx) => {
                        return (
                          <div
                            key={idx}
                            className={`flex ${classBy === element.value
                              ? "text-primary"
                              : "text-[#000000]"
                              }   justify-between cursor-pointer  items-center`}
                            onClick={() => {
                              ...
                              if (!search?.name?.length || search === {}) {
                                ...
                                if (element.value.length) {
                                  ...
                                  if (
                                    element?.value?.toString() == "Class 9" ||
                                    element?.value?.toString() == "Class 10"
                                  ) {
                                    json = {
                                      "Higher Secondary School (Class 9-10th)":
                                      {
                                  ...
                                  if (
                                    element?.value?.toString() == "Class 1" ||
                                    element?.value?.toString() == "Class 2" ||
                                    element?.value?.toString() == "Class 3" ||
                                    element?.value?.toString() == "Class 4" ||
                                    element?.value?.toString() == "Class 5" ||
                                    element?.value?.toString() == "Class 6" ||
                                    element?.value?.toString() == "Class 7" ||
                                    element?.value?.toString() == "Class 8"
                                  ) {
                                    json = {
                                      "Junior Secondary School (Class 6-8th)": {
                                        classes: [element?.value?.toString()],
                      ...
                      {subjectData
                        ...
                        ?.map((element, idx) => {
                          return (
                            <div
                              key={idx}
                              className={`flex ${subjectBy === element.value
                                ? "text-primary"
                                : "text-[#000000]"
                                }   justify-between cursor-pointer  items-center`}
                              onClick={() => {
                  ...
                  >
                    {examsData?.map((element, idx) => {
                      return (
                        <div
                          key={idx}
                          className={`flex ${examBy?.name === element?.value
                            ? "text-primary"
                            : "text-[#000000]"
                            }   justify-between cursor-pointer  items-center`}
                          onClick={() => {
        ...
        <div className="relative">
          <p
            ...
            className="flex w-full justify-between items-center md:w-44 cursor-pointer border-2 border-solid border-light-gray   p-2"
          >
            <p className={` text-[#000000] text-[14px] `}>
          ...
          {ratingShow ? (
            <>
              ...
              <div className="absolute left-0 z-10 mt-5 w-56 origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                <div className="py-1 divide-y divide-gray/20" role="none">
                  <div
                    className={`flex  ${ratings === 5 ? "text-primary" : "text-[#000000]"
                      } justify-between cursor-pointer  items-center`}
                    onClick={() => {
                      setRatings(5);
                    }}
                  ...
                  <div
                    ...
                    className={`flex   ${ratings === 4 ? "text-primary" : "text-[#000000]"
                      } justify-between cursor-pointer  items-center`}
                  >
                  ...
                  <div
                    ...
                    className={`flex   ${ratings === 3 ? "text-primary" : "text-[#000000]"
                      } justify-between cursor-pointer  items-center`}
                  >
                  ...
                  <div
                    ...
                    className={`flex   ${ratings === 2 ? "text-primary" : "text-[#000000]"
                      } justify-between cursor-pointer  items-center`}
                  >
                  ...
                  <div
                    ...
                    className={`flex   ${ratings === 1 ? "text-primary" : "text-[#000000]"
                      } justify-between cursor-pointer  items-center`}
                  >
                  ...
                  <div
                    ...
                    className={`flex   ${ratings === "" ? "text-primary" : "text-[#000000]"
                      } justify-between cursor-pointer  items-center`}
                  >
      ...
      <div className="md:p-5 container mx-auto">
        <img
...
export default LocationRecommended;
