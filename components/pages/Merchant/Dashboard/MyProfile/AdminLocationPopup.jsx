...
const AdminLocationPopup = ({
  ...
  const handleSave = async (e) => {
    ...
    //   areas.push(
    //     element.line1?.toLowerCase().trim(),
    //     element.line2?.toLowerCase().trim(),
    ...
    // const unique = areas?.filter((element) => {
    ...
    try {
      const res = await axios.patch(`${host}/${url}`, updateData, {
        headers: {
